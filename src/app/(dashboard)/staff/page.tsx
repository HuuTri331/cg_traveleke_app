...
export default function StaffPage() {
  ...
  const handleCreateStaff = async (
    ...
    try {
      ...
      success(
        'Thành công',
        `Đã tạo tài khoản nhân viên "${createForm.fullName}".`,
      );
  ...
  const handleEditStaff = async (
    ...
    try {
      ...
      success(
        'Thành công',
        `Đã cập nhật thông tin nhân viên "${selectedStaff.fullName}".`,
      );
  ...
  const handleChangeRole = async () => {
    ...
    try {
      ...
      success(
        'Thành công',
        `Đã đổi vai trò của "${selectedStaff.fullName}" thành ${newRole}.`,
      );
  ...
  const handleToggleStatus = async (
    ...
    if (
      !confirm(
        `Bạn có chắc chắn muốn ${actionLabel} tài khoản "${staff.fullName}"?`,
      )
    ) {
      return;
    }
    ...
    try {
      ...
      success(
        'Thành công',
        `Đã ${actionLabel} tài khoản "${staff.fullName}".`,
      );
  ...
  const handleDeleteStaff = async (
    ...
    if (
      !confirm(
        `Bạn có chắc chắn muốn xóa tài khoản "${staff.fullName}"?`,
      )
    ) {
      return;
    }
    ...
    try {
      ...
      success(
        'Thành công',
        `Đã xóa tài khoản "${staff.fullName}".`,
      );
    ...
    return (
      <div className="flex flex-col items-center justify-center p-8 bg-white dark:bg-gray-900 rounded-3xl border border-gray-200 dark:border-gray-800 shadow-sm text-center my-12 max-w-lg mx-auto">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 max-w-sm">
          Trang Quản Lý Nhân Sự chỉ dành riêng cho tài khoản có vai trò{' '}
          <strong>
            Quản Trị Viên (ADMIN)
          </strong>.
        </p>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="font-bold text-gray-900 dark:text-white flex items-center gap-1.5">
                                ...
                                {isCurrent && (
                                  <span className="text-[9px] px-1.5 py-0.5 rounded-md bg-brand-50 text-brand-600 dark:bg-brand-500/20 dark:text-brand-400 font-bold border border-brand-200 dark:border-brand-500/30">
                                    Bạn
                                  </span>
                                )}
                              </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-[11px] text-gray-500 mt-1 flex items-center gap-1">
                  ...
                  Nếu để trống, mật khẩu mặc định sẽ là{' '}
                  <strong>
                    123456789
                  </strong>.
                </p>
